...
exports.validTcoUrl = exports.validMention = exports.validHashtag = exports.validAsciiDomain = exports.hashSigns = exports.extractUrl = exports.endMentionMatch = exports.endHashtagMatch = exports.atSigns = void 0;
var _regexSupplant = _interopRequireDefault(require("./_regexSupplant"));
var _validCCTLD = _interopRequireDefault(require("./_validCCTLD"));
var _validGTLD = _interopRequireDefault(require("./_validGTLD"));
...
var validUrlBalancedParens = (0, _regexSupplant.default)('\\(' + '(?:' + '#{validGeneralUrlPathChars}+' + '|' +
...
var invalidDomainChars = _stringSupplant('#{punct}#{spacesGroup}#{invalidCharsGroup}#{directionalMarkersGroup}', {
  punct: punct,
...
// URLs
var extractUrl = exports.extractUrl = (0, _regexSupplant.default)('(' +
// $1 total match
...
var validAsciiDomain = exports.validAsciiDomain = (0, _regexSupplant.default)(/(?:(?:[-a-z0-9#{latinAccentChars}]+)\.)+(?:#{validGTLD}|#{validCCTLD}|#{validPunycode})/gi, {
  latinAccentChars: latinAccentChars,
  validGTLD: _validGTLD.default,
  validCCTLD: _validCCTLD.default,
  validPunycode: validPunycode
});
var validTcoUrl = exports.validTcoUrl = (0, _regexSupplant.default)(/^https?:\/\/t\.co\/([a-z0-9]+)(?:\?#{validUrlQueryChars}*#{validUrlQueryEndingChars})?/, {
  validUrlQueryChars: validUrlQueryChars,
  validUrlQueryEndingChars: validUrlQueryEndingChars
}, 'i');
...
var hashSigns = exports.hashSigns = /[#＃]/;
var endHashtagMatch = exports.endHashtagMatch = (0, _regexSupplant.default)(/^(?:#{hashSigns}|:\/\/)/, {
  hashSigns: hashSigns
});
var validHashtag = exports.validHashtag = (0, _regexSupplant.default)(/(#{hashtagBoundary})(#{hashSigns})(?!\uFE0F|\u20E3)(#{hashtagAlphaNumeric}*#{hashtagAlpha}#{hashtagAlphaNumeric}*)/gi, {
...
var atSigns = exports.atSigns = /[@＠]/;
var endMentionMatch = exports.endMentionMatch = (0, _regexSupplant.default)(/^(?:#{atSigns}|[#{latinAccentChars}]|:\/\/)/, {
  atSigns: atSigns,
  latinAccentChars: latinAccentChars
});
var validMention = exports.validMention = (0, _regexSupplant.default)('(#{validMentionPrecedingChars})' +
